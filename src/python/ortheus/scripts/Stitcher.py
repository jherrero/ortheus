...
def addDefaultStitcherArgs(alignerArgs):
    ...
    alignerArgs.ALIGNER_PREFIX =  " -cp %s bp.pecan.Pecan " % os.path.join(ortheusPath, "src/python/ortheus/localLib/pecan.jar")
    #alignerArgs.ALIGNER_PREFIX =  " bp.pecan.Pecan"
    alignerArgs.RECONSTRUCTION_PREFIX = os.path.join(ortheusPath, "bin/OrtheusC")
